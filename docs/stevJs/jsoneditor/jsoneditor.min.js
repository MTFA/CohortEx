...
var f=this.property_order.length,g=this.property_order;this.property_order=Object.keys(this.editors),this.property_order=this.property_order.sort(function(a,b){var d=c.editors[a].schema.propertyOrder,e=c.editors[b].schema.propertyOrder;"number"!=typeof d&&(d=1e3),"number"!=typeof e&&(e=1e3);var f="categories"==c.format&&("object"==c.editors[a].schema.type||"array"==c.editors[a].schema.type),g="categories"==c.format&&("object"==c.editors[b].schema.type||"array"==c.editors[b].schema.type);return"boolean"==typeof f&&f&&(d+=1e4),"boolean"==typeof g&&g&&(e+=1e4),d-e});var h,i=this.property_order.length;if("grid"===this.format){var j=[];
...
for(var e=!1,f=d.options.hidden?0:d.options.grid_columns||d.getNumColumns(),g=d.options.hidden?0:d.container.offsetHeight,h=0;h<j.length;h++)
// If the editor will fit in the row horizontally
j[h].width+f<=12&&(!g||.5*j[h].minh<g&&2*j[h].maxh>g)&&(e=h);
// If there isn't a spot in any of the existing rows, start a new row
e===!1&&(j.push({width:0,minh:999999,maxh:0,editors:[]}),e=j.length-1),j[e].editors.push({key:b,
//editor: editor,
width:f,height:g}),j[e].width+=f,j[e].minh=Math.min(j[e].minh,g),j[e].maxh=Math.max(j[e].maxh,g)}}),a=0;a<j.length;a++)if(j[a].width<12){var k=!1,l=0;for(b=0;b<j[a].editors.length;b++)k===!1?k=b:j[a].editors[b].width>j[a].editors[k].width&&(k=b),j[a].editors[b].width*=12/j[a].width,j[a].editors[b].width=Math.floor(j[a].editors[b].width),l+=j[a].editors[b].width;l<12&&(j[a].editors[k].width+=12-l),j[a].width=12}
// layout hasn't changed
if(this.layout===JSON.stringify(j))return!1;for(this.layout=JSON.stringify(j),
// Layout the form
h=document.createElement("div"),a=0;a<j.length;a++){var m=this.theme.getGridRow();for(h.appendChild(m),b=0;b<j[a].editors.length;b++){var n=j[a].editors[b].key,o=this.editors[n];o.options.hidden?o.container.style.display="none":this.theme.setGridColumnSize(o.container,j[a].editors[b].width),m.appendChild(o.container)}}}else if("categories"===this.format){
////////////////
var p,q,r,s,t=0,u=0,v=!1,w=0,x=0,y=!1,z=0;if(f>i){
//property deleted
for(var A=0;A<f&&(u=A,p=g[A],q=this.cached_editors[p],v="object"===q.schema.type||"array"===q.schema.type,
//Looking for a deleted property, update currentTab
//if the current property is complex, it has a tab to hold it
v&&w++,this.property_order[A]===g[A]);A++);v||(this.containerRowFluid.innerHTML="")}else{
//property added
for(var B=0;B<i&&(x=B,r=this.property_order[B],s=this.cached_editors[r],y="object"===s.schema.type||"array"===s.schema.type,this.property_order[B]===g[B]);B++)
//Still looking for a added property, update currentTab
//if the current property is complex, it has a tab to hold it
y&&z++;y||(this.containerRowFluid.innerHTML="")}var C=!1,D=0;if(d(this.property_order,function(a,b){var d=c.editors[b];"object"===d.schema.type||"array"===d.schema.type?D++:C=!0}),C&&D++,"row-fluid"==this.row_container.className)if(this.row_container.childElementCount>D)v?(this.row_container.removeChild(q.container),this.tabs_holder.childNodes[0].removeChild(q.tab)):(this.row_container.removeChild(this.row_container.childNodes[0]),this.tabs_holder.childNodes[0].removeChild(this.tabs_holder.childNodes[0].childNodes[0])),e(this.tabs_holder.childNodes[0].childNodes[0],"click");else if(this.row_container.childElementCount==D)d(this.property_order,function(a,b){var d=c.editors[b],e="object"==d.schema.type||"array"==d.schema.type;if(!d.property_removed){if(0==t||e){if(0==t)"object"!=c.rows[0].schema.type&&"array"!=c.rows[0].schema.type||c.addRow(d,!0);else{if(1==t)return void t++;if(t>1)return}t++}var f=c.theme.getGridRow();c.containerRowFluid.appendChild(f),d.options.hidden?d.container.style.display="none":c.theme.setGridColumnSize(d.container,12),f.appendChild(d.container)}});else{var E=c.theme.getTabContent();if(y)
//Add a panel
"tab-pane active"!=s.container.className?(E.appendChild(s.container),this.row_container.appendChild(E)):this.row_container.appendChild(s.container),c.tabs_holder.childNodes[0].appendChild(s.tab),e(s.tab,"click");else{var F=this.theme.getGridRow();
//check for a raw container and add one if not
this.row_container.childNodes.length>0?"container-fluid"!=this.row_container.childNodes[0].childNodes[0].className?(
//add a container at 0
this.row_container.insertBefore(E,this.row_container.childNodes[0]),this.containerRowFluid=this.theme.getGridContainer(),this.containerRowFluid.appendChild(F),E.appendChild(this.containerRowFluid),s.options.hidden?s.container.style.display="none":this.theme.setGridColumnSize(s.container,12),F.appendChild(s.container),this.addTab(0),c.tabs_holder.childNodes[0].insertBefore(c.rows[0].tab,c.tabs_holder.childNodes[0].childNodes[0]),e(this.tabs_holder.childNodes[0].childNodes[0],"click")):(this.containerRowFluid.appendChild(F),s&&(s.options.hidden?s.container.style.display="none":this.theme.setGridColumnSize(s.container,12),F.appendChild(s.container))):(
//add a container at 0
this.row_container.insertBefore(E,this.row_container.childNodes[0]),this.containerRowFluid=this.theme.getGridContainer(),this.containerRowFluid.appendChild(F),E.appendChild(this.containerRowFluid),s.options.hidden?s.container.style.display="none":this.theme.setGridColumnSize(s.container,12),F.appendChild(s.container),this.addTab(0),c.tabs_holder.childNodes[0].appendChild(c.rows[0].tab),e(this.tabs_holder.childNodes[0].childNodes[0],"click"))}}}else h=document.createElement("div"),d(this.property_order,function(a,b){var d=c.editors[b];if(!d.property_removed){var e=c.theme.getGridRow();h.appendChild(e),d.options.hidden?d.container.style.display="none":c.theme.setGridColumnSize(d.container,12),e.appendChild(d.container)}}),this.row_container.innerHTML="",this.row_container.appendChild(h)}},getPropertySchema:function(a){
...
// Sort editors by propertyOrder
this.property_order=Object.keys(this.editors),this.property_order=this.property_order.sort(function(b,c){var d=a.editors[b].schema.propertyOrder,e=a.editors[c].schema.propertyOrder;"number"!=typeof d&&(d=1e3),"number"!=typeof e&&(e=1e3);var f="categories"==a.format&&("object"==a.editors[b].schema.type||"array"==a.editors[b].schema.type),g="categories"==a.format&&("object"==a.editors[c].schema.type||"array"==a.editors[c].schema.type);return"boolean"==typeof f&&f&&(d+=1e4),"boolean"==typeof g&&g&&(e+=1e4),d-e})},addTab:function(a){var b=this;b.tabs_holder&&(b.rows[a].tab_text=document.createElement("span"),0==a?b.rows[a].tab_text.textContent=void 0===b.schema.main_title?"Basic":b.schema.main_title:b.rows[a].tab_text.textContent=b.rows[a].getHeaderText(),b.rows[a].tab=b.theme.getTab(b.rows[a].tab_text),b.rows[a].tab.addEventListener("click",function(c){b.active_tab=b.rows[a].tab,b.refreshTabs(),c.preventDefault(),c.stopPropagation()}))},addRow:function(a,b){var c=this,d=this.rows.length;0!=d&&"object"!==a.schema.type&&"array"!==a.schema.type||(c.rows[d]=a,c.addTab(d),c.theme.addTab(c.tabs_holder,c.rows[d].tab))},refreshTabs:function(a){var b=this;d(this.rows,function(c,d){d.tab&&(a&&(d.tab_text.textContent=d.getHeaderText()),d.tab===b.active_tab?(b.theme.markTabActive(d.tab),"span12"===d.container.className?b.row_container.children[0].style.display="":d.container.style.display=""):(b.theme.markTabInactive(d.tab),"span12"===d.container.className?b.row_container.children[0].style.display="none":d.container.style.display="none"))})},build:function(){var a=this;
// If the object should be rendered as a table row
...
this.editor_holder=this.theme.getIndentedPanel(),this.container.appendChild(this.editor_holder),"categories"===this.schema.format){var c=!0;a.containerRowFluid=this.theme.getGridContainer(),
//this.colHolder = this.theme.getGridColumn();
this.rows=[],this.active_tab=null,this.tabs_holder=this.theme.getTopTabHolder(),this.editor_holder.appendChild(this.tabs_holder),
// Container for rows of child editors
this.row_container=this.theme.getTabContentHolder(this.tabs_holder);var f=a.theme.getGridRow();this.row_container.appendChild(f),this.row_container=f,d(this.editors,function(b,d){var e=a.theme.getTabContent(),f=e,g=a.theme.getGridRow(),h=a.theme.getGridColumn();g.appendChild(h),a.addRow(d,!0),"object"!==d.schema.type&&"array"!==d.schema.type?(a.containerRowFluid.appendChild(g),1==c&&(f.appendChild(a.containerRowFluid),c=!1,a.row_container.appendChild(f)),f=g):a.row_container.appendChild(f),d.setContainer(f),d.build(),d.postBuild(),a.editors[b].options.hidden&&(f.style.display="none"),a.editors[b].options.input_width&&(f.style.width=a.editors[b].options.input_width)}),e(this.rows[0].tab,"click")}else
// Container for rows of child editors
...
//category format
if("categories"===this.schema.format){var g=c.theme.getGridRow();c.containerRowFluid.appendChild(g),f=g}else c.editor_holder.appendChild(f);c.editors[a].setContainer(f),c.editors[a].build(),c.editors[a].postBuild()}c.cached_editors[a]=c.editors[a]}
