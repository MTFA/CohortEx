...
-- **********************************************
BEGIN
     EXECUTE IMMEDIATE 'DROP VIEW INDICATOR_DIAGNOSIS_PROFILE_P';
EXCEPTION
     WHEN OTHERS THEN
            IF SQLCODE != -942 THEN
                 RAISE;
...
-- **********************************************
BEGIN
     EXECUTE IMMEDIATE 'DROP VIEW INDICATOR_ICD10_CONFORMITY_P';
EXCEPTION
     WHEN OTHERS THEN
            IF SQLCODE != -942 THEN
                 RAISE;
...
CREATE TABLE STUDY_RESEARCH
        (
          ...
          , CONSTRAINT "RESEARCH_PK" PRIMARY KEY (RESEARCH_ID)   ENABLE
        );
/
...
CREATE TABLE STUDY
        (
          ...
          , DESCRIPTION   VARCHAR2(300) NOT NULL ENABLE
          , CONSTRAINT "MODEL_PK" PRIMARY KEY (STUDY_ID)   ENABLE
        );
/
...
CREATE TABLE STUDY_RESEARCHER
        (
          ...
          , DESCRIPTION   VARCHAR2(300) NOT NULL ENABLE
          , CONSTRAINT "RESEARCHER_PK" PRIMARY KEY (RESEARCHER_ID)   ENABLE
        );
/
...
CREATE TABLE STUDY_CURRENT_RUN
        (
          ...
          , RESEARCHER_ID VARCHAR2(40) NOT NULL ENABLE
          , ACTIVE        NUMBER(1)
          , CONSTRAINT "STUDY_CURRENT_RUN_PK" PRIMARY KEY (RESEARCH_ID, STUDY_ID, RESEARCHER_ID)  ENABLE
...
CREATE TABLE STUDY_PARAMS_YES_Y_NO_N_TYPE
       (  
        ...
        , CONSTRAINT STR_PARAMSYESNO_PK    PRIMARY KEY (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID)  ENABLE
...
CREATE TABLE STUDY_PARAMS_STRING_TYPE
       (  
        ...
        , INCLUSION_DATE DATE
        , MODIFICATION_DATE DATE
        , CONSTRAINT STR_PARAMETERS_PK    PRIMARY KEY (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID)  ENABLE
...
CREATE TABLE STUDY_PARAMS_DATE_TYPE
     (  
      ...
      , INCLUSION_DATE DATE
      , MODIFICATION_DATE DATE
      , CONSTRAINT DATE_PARAMETERS_PK    PRIMARY KEY (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID)  ENABLE
...
CREATE TABLE STUDY_PARAMS_NUMBER_TYPE
       (  
        ...
        , INCLUSION_DATE DATE
        , MODIFICATION_DATE DATE
        , CONSTRAINT NUM_PARAMETERS_PK    PRIMARY KEY (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID)  ENABLE
...
-- **********************************************
  CREATE TABLE "STUDY_DRUG" 
         (  
          ...
          , "RESEARCH_ID"       VARCHAR2(40) NOT NULL ENABLE
          , "RESEARCHER_ID"     VARCHAR2(40) NOT NULL ENABLE
          , CONSTRAINT "DRUG_STDY_PK"     PRIMARY KEY (DRUG_ID, RESEARCH_ID, RESEARCHER_ID)   ENABLE
...
CREATE INDEX SD_DID ON STUDY_DRUG(DRUG_ID) ;
CREATE INDEX SD_DIDID ON STUDY_DRUG(DRUG_ID,INTERVENTION_DRUG) ;
-- **********************************************
...
CREATE INDEX CRSP_CPIE ON CURRENT_RUN_STR_PARAMS (CRITERIA_ID,PARAMETER_TYPE,INCLUSION_EXCLUSION)  ;
...
CREATE INDEX FPE_PATIENTID  ON FILTER_PATIENT_ENROLLMENT (PATIENT_ID)              ;
CREATE INDEX FPE_DEIDENTID  ON FILTER_PATIENT_ENROLLMENT (DEIDENTIFIED_ID)         ;
CREATE INDEX FPE_RID        ON FILTER_PATIENT_ENROLLMENT (RECORD_INCLUSION_DATE)   ;
CREATE INDEX FPE_BD         ON FILTER_PATIENT_ENROLLMENT (BIRTH_DATE)              ;
CREATE INDEX FPE_PN         ON FILTER_PATIENT_ENROLLMENT (PATIENT_NAME)            ;
CREATE INDEX FPE_PMN        ON FILTER_PATIENT_ENROLLMENT (PATIENT_MOTHER_NAME)     ;
...
CREATE INDEX FDE_PATIENTID  ON FILTER_DIAGNOSIS_ENROLLMENT (PATIENT_ID)                ;
CREATE INDEX FDE_DIAGID     ON FILTER_DIAGNOSIS_ENROLLMENT (DIAGNOSIS_ID)              ;
CREATE INDEX FDE_PATDIAGID  ON FILTER_DIAGNOSIS_ENROLLMENT (PATIENT_ID,DIAGNOSIS_ID)   ;
CREATE INDEX FDE_ICD10      ON FILTER_DIAGNOSIS_ENROLLMENT (ICD10)                     ;
...
CREATE INDEX FADE_PATIENTID   ON FILTER_ADM_DISCH_ENROLLMENT (PATIENT_ID)                                ;
CREATE INDEX FADE_PATADYADID  ON FILTER_ADM_DISCH_ENROLLMENT (PATIENT_ID,ADMISSION_YEAR,ADMISSION_ID)    ;
...
CREATE INDEX FLE_PATIDLABIDTN  ON FILTER_LABORATORY_ENROLLMENT (PATIENT_ID,LAB_TEST_ID,LAB_TEST_CODE)    ;
...
CREATE INDEX VP_PATID ON VALID_PATIENT(PATIENT_ID)  ;
 -- ******************************************************
...
-- CREATE INDEX DDP_PATIENTID ON DETECT_DUPLICATE_PATIENT_ID (PATIENT_ID) ;
...
CREATE INDEX DPD_PATIENTID ON DETECT_PATIENT_DUPLICATES (PATIENT_ID) ;
        ...
        FROM 
                ...
                SELECT 
                      ...
                      CASE 
                        ...
                        ELSE 'Diagnóstico não especificado ou inválido' END) AS "DESCRIPTION" 
                      FROM  (  
                              SELECT 
                                  PATIENT_ID
...
-- **********************************************
CREATE OR REPLACE VIEW "INDICATOR_DIAGNOSIS_PROFILE_P" AS
(
SELECT 
          "Capítulo CID"
        , "Descrição" 
...
-- **********************************************
CREATE OR REPLACE VIEW INDICATOR_ICD10_CONFORMITY_P as
(
select 
   (
    SELECT 
...
CREATE UNIQUE INDEX CLEANPAT ON CLEAN_PATIENT (PATIENT_ID)  ;
...
CREATE UNIQUE INDEX CLEANDIAG ON CLEAN_DIAGNOSIS (PATIENT_ID,DIAGNOSIS_ID)  ;
...
CREATE UNIQUE INDEX BPPATDIAG ON BP_DIAGNOSIS (PATIENT_ID,DIAGNOSIS_ID)  ;
CREATE INDEX BPDPAT ON BP_DIAGNOSIS (PATIENT_ID)  ;
CREATE INDEX BPICD10 ON BP_DIAGNOSIS (ICD10)  ;
CREATE INDEX BPICD10FC ON BP_DIAGNOSIS (SUBSTR(ICD10,1,3))  ;
CREATE INDEX BPICD10SC ON BP_DIAGNOSIS (SUBSTR(ICD10,1,5))  ;
CREATE INDEX BPICD10EL ON BP_DIAGNOSIS (SUBSTR(ICD10,1,7))  ;
CREATE INDEX BPICD10EX ON BP_DIAGNOSIS (SUBSTR(ICD10,1,8))  ;
...
CREATE UNIQUE INDEX BPPAT ON BP_PATIENT (PATIENT_ID)  ;
...
CREATE UNIQUE INDEX BPLABPATLAB ON BP_LABORATORY (PATIENT_ID,LAB_TEST_ID,LAB_TEST_CODE)  ;
CREATE INDEX BPLABPAT ON BP_LABORATORY (PATIENT_ID)  ;
...
CREATE INDEX BPPCIPAT ON BP_PCI (PATIENT_ID)  ;
...
CREATE INDEX BPS_PATIENT_ID ON BP_SURGERY (PATIENT_ID) ;
...
CREATE INDEX BPFOE_PATIENT_ID ON BP_FIRST_OUTPATIENT_ENCOUNTER (PATIENT_ID) ;
...
CREATE INDEX BPHRFE_PATIENT_ID ON BP_HEART_RISK_FACTOR (PATIENT_ID) ;
...
CREATE INDEX BPD_PATID ON BP_DEATH (PATIENT_ID) ;
...
CREATE INDEX BPDR_PATID ON BP_DRUGS (PATIENT_ID) ;
...
CREATE INDEX IPWOD_PACIID ON INDICATOR_PAT_WITH_DIAG (PATIENT_ID)  ;
...
CREATE INDEX IPWOUTD_PACIID ON INDICATOR_PAT_WOUT_DIAG (PATIENT_ID)  ;
...
CREATE INDEX CSPA_PATID ON COHORT_SELECTOR_PATIENT_AGE(PATIENT_ID)  ;
...
CREATE INDEX CSPG_PATID ON COHORT_SELECTOR_PATIENT_GENDER(PATIENT_ID)  ;
...
-- CREATE INDEX CSSILPATID  ON COHORT_SELECTOR_STUDY_INT_LAB (PATIENT_ID)  ;
-- ******************************************************
...
CREATE INDEX CSSIIPATID  ON COHORT_SELECTOR_STUDY_INTERVAL (PATIENT_ID)  ;
CREATE INDEX CSSIICD10   ON COHORT_SELECTOR_STUDY_INTERVAL (ICD10)  ;
CREATE INDEX CSSIICD10FC ON COHORT_SELECTOR_STUDY_INTERVAL (SUBSTR(ICD10,1,3))  ;
CREATE INDEX CSSIICD10SC ON COHORT_SELECTOR_STUDY_INTERVAL (SUBSTR(ICD10,1,5))  ;
CREATE INDEX CSSIICD10EL ON COHORT_SELECTOR_STUDY_INTERVAL (SUBSTR(ICD10,1,7))  ;
CREATE INDEX CSSIICD10EX ON COHORT_SELECTOR_STUDY_INTERVAL (SUBSTR(ICD10,1,8))  ;
...
CREATE INDEX CSDPATID  ON COHORT_SELECTOR_DIAGNOSIS (PATIENT_ID)  ;
...
CREATE INDEX OSDPATID  ON OUTCOME_SELECTOR_DIAGNOSIS (PATIENT_ID)  ;
...
CREATE INDEX CSSSBDPATID  ON COHORT_SELECTOR_SURGERY_DIAG (PATIENT_ID)  ;
...
/
-- CREATE INDEX SAT_PATIENT_ID ON STUDY_PCI_TRANSPOSED (PATIENT_ID) ;
...
CREATE INDEX TSNL_PATIENT_ID ON TRANSFORM_SELECT_NUM_LABTST (PATIENT_ID) ;
CREATE INDEX TSNL_PATLABIDCOD ON TRANSFORM_SELECT_NUM_LABTST (PATIENT_ID,LAB_TEST_ID,LAB_TEST_CODE) ;
CREATE INDEX TSNL_PATLABNAMCOD ON TRANSFORM_SELECT_NUM_LABTST (PATIENT_ID,LAB_TEST_NAME,LAB_TEST_CODE) ;
...
(
  ...
  ON
    BPD.PATIENT_ID = CSD.PATIENT_ID
  INNER JOIN
    (
      SELECT 
                            PATIENT_ID
        , MIN(DIAGNOSIS_ID) FIRST_DIAGNOSIS_ID
    FROM 
      BP_DIAGNOSIS
    GROUP BY 
      PATIENT_ID
  ...
  ON
        BPD.PATIENT_ID   = FST_DIAGID.PATIENT_ID
    AND BPD.DIAGNOSIS_ID = FST_DIAGID.FIRST_DIAGNOSIS_ID
);
...
SELECT 
          A.PATIENT_ID
        , A.ICD10                 AS ICD10_FIRST_SURGERY
        , B.FIRST_SURGERY_DATE
        , C.ICD10                 AS ICD10_LAST_SURGERY
        , B.LAST_SURGERY_DATE
        , B.SURGERY_INTERVAL
        , B.SURGERY_QUANTITY
...
CREATE INDEX TTS_PATIENT_ID ON TRANSFORM_TRANSPOSE_SURGERY (PATIENT_ID) ;
...
CREATE INDEX CRI_PATIENT_ID ON TRANSFORM_LINEAR_REG_LABTST (PATIENT_ID) ;
...
CREATE INDEX TGL_PATIENT_ID ON TRANSFORM_GETDELTA_LABTEST (PATIENT_ID) ;
...
CREATE INDEX COHOADM_PATIENT_ID ON VALID_ADMISSION (PATIENT_ID) ;
CREATE INDEX COHOADM_PID_Y_ADM  ON VALID_ADMISSION (PATIENT_ID,ADMISSION_YEAR,ADMISSION_ID,DISCHARGE_ID) ;
...
CREATE INDEX BPAD_PATID ON BP_ADMISSION_DISCHARGE(PATIENT_ID)  ;
CREATE INDEX BPAD_ADSEC ON BP_ADMISSION_DISCHARGE(ADMISSION_SECTOR)  ;
...
(
SELECT 1 AS ID
  ,(SELECT COUNT(*) FROM FILTER_PATIENT_ENROLLMENT) AS RAW_TOTAL_PATIENTS
  ,(SELECT COUNT (*) FROM VALID_PATIENT) AS DN_NOT_NULL
  ,(SELECT COUNT (*) FROM BP_PATIENT) AS NO_DUPLICATES
  ...
  ,(SELECT COUNT (*) FROM FILTER_DIAGNOSIS_ENROLLMENT) AS RAW_TOTAL_DIAGNOSIS
  ...
  -- ,(SELECT COUNT(*) FROM ALL_PATIENT A INNER JOIN STUDY_FIRST_DIAGNOSIS B ON A.PATIENT_ID=B.PATIENT_ID) AS WITH_DCVA
  -- ,(SELECT COUNT (*) FROM STUDY_PATIENT) AS ADULTS_WITH_DCVA
  -- ,(SELECT COUNT(*) FROM MODEL_ONE_CLEAN_NO_SIM) AS EFFECTIVE_OBSERVATIONS
  FROM DUAL
);
...
CREATE INDEX AUXE_PATID ON AUX_ENCOUNTERS(PATIENT_ID)  ;
...
CREATE INDEX CSE_PATID ON COHORT_SELECTOR_ENCOUNTERS(PATIENT_ID)  ;
...
CREATE INDEX PAUAC_PATIENT_ID ON SELECTED_PATIENT (PATIENT_ID) ;
...
CREATE INDEX SD_PATIENT_ID ON SELECTED_DIAGNOSIS (PATIENT_ID) ;
...
CREATE INDEX SP_PATIENT_ID ON SELECTED_PCI (PATIENT_ID) ;
...
CREATE INDEX SD_PATI_ID ON SELECTED_DEATH (PATIENT_ID) ;
...
CREATE INDEX SDRG_PATI_ID ON SELECTED_DRUGS (DEIDENTIFIED_ID) ;
...
CREATE INDEX TFE_PATID  ON TRANSFORM_FIRSTLAST_ENCOUNTER (PATIENT_ID)  ;
...
CREATE INDEX TTEPPATID  ON TRANSFORM_TRANSP_ENC_PROFILE (PATIENT_ID)  ;
...
CREATE INDEX CSSDPATID  ON OUTCOME_SELECTOR_PCI (PATIENT_ID)  ;
...
CREATE INDEX OSWTPATID  ON OUTCOME_SELECTOR_WASHOUT_TIME (PATIENT_ID)  ;
...
CREATE INDEX OSSPATID  ON OUTCOME_SELECTOR_SURGERY (PATIENT_ID)  ;
...
-- CREATE INDEX CE_DEID_ID ON COHORT_ENCOUNTER (DEIDENTIFIED_ID)  ;
...
-- CREATE INDEX CFOE_DEID_ID ON COHORT_FRST_OUTPAT_ENCOUNTER (DEIDENTIFIED_ID)  ;
...
-- CREATE INDEX PAUA_CH_RF ON COHORT_HEART_RISK_FACTOR (DEIDENTIFIED_ID)  ;
...
SELECT  
       ...
       , MAX(INTERVENTION_DRUG) AS INTERVENTION_DFLAG
       , FLOOR(MAX(AGE_AT_ERA_END) - MIN(AGE_AT_ERA_BEGIN)) STATIN_AMOUNTH_MONTHS
FROM
  SELECTED_DRUGS
GROUP BY 
...
SELECT  
       ...
       , FLOOR(MAX(AGE_AT_ERA_END) - MIN(AGE_AT_ERA_BEGIN)) AS STATIN_AMOUNTH_MONTHS
FROM
  SELECTED_DRUGS
GROUP BY 
  DEIDENTIFIED_ID,DRUG_ID
...
(
  SELECT 
    ...
    , FLOOR(TFS.FIRST_SURGERY_DATE - SD.BIRTH_DATE)   AS AGE_FIRST_SURGERY
    , TFS.ICD10_LAST_SURGERY
    , FLOOR(TFS.LAST_SURGERY_DATE - SD.BIRTH_DATE)    AS AGE_LAST_SURGERY
    , TFS.SURGERY_INTERVAL
    , TFS.SURGERY_QUANTITY

    , FLOOR(TTS.SRGRY_DATE_1 - SD.BIRTH_DATE)   AS AGE_SURGERY_1
    , TTS.WEIGHT_1
    , TTS.HEIGHT_1
    , TTS.ICD10_1
    , TTS.DIAGNOSIS_1
    ...
    , FLOOR(TTS.SRGRY_DATE_2 - SD.BIRTH_DATE)   AS AGE_SURGERY_2
    , TTS.WEIGHT_2
    , TTS.HEIGHT_2
    , TTS.ICD10_2
    , TTS.DIAGNOSIS_2
    ...
    , FLOOR(TTS.SRGRY_DATE_3 - SD.BIRTH_DATE)   AS AGE_SURGERY_3
    , TTS.WEIGHT_3
    , TTS.HEIGHT_3
    , TTS.ICD10_3
    , TTS.DIAGNOSIS_3
    ...
    , FLOOR(TTS.SRGRY_DATE_4 - SD.BIRTH_DATE)   AS AGE_SURGERY_4
    , TTS.WEIGHT_4
    , TTS.HEIGHT_4
    , TTS.ICD10_4
    , TTS.DIAGNOSIS_4
...
INNER JOIN 
  SELECTED_DIAGNOSIS SD
ON
  TFS.PATIENT_ID = SD.PATIENT_ID
INNER JOIN
