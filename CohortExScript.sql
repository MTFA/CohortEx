...
BEGIN
   EXECUTE IMMEDIATE 'DROP VIEW COHORT_SURVIVAL';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
-- **********************************************
BEGIN
     EXECUTE IMMEDIATE 'DROP VIEW DETECT_INVALID_INDEX';
EXCEPTION
     WHEN OTHERS THEN
            IF SQLCODE != -942 THEN
                 RAISE;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP VIEW COHORT_SELECTION_CRITERIA_PT';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP VIEW COHORT_INTERVENTION';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
INSERT INTO STUDY_RESEARCH (RESEARCH_ID,DESCRIPTION) VALUES ('DCV_GENETICA','STUDY ABOUT DCV GENETICS');
...
INSERT INTO STUDY_CURRENT_RUN (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,ACTIVE) VALUES ('DCV_DISEASE','MODEL_ONE','TEREZA',0);
INSERT INTO STUDY_CURRENT_RUN (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,ACTIVE) VALUES ('DCV_WOMEN','MODEL_ONE','TEREZA',0);
INSERT INTO STUDY_CURRENT_RUN (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,ACTIVE) VALUES ('DCV_GENETICA','MODEL_ONE','TEREZA',1);
...
INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','DIAGNOSIS_SELECTION','FILTER_ENABLING',1,'Y','ENABLE DIAGNOSIS FILTERING',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','STUDY_GENDER','FILTER_ENABLING',1,'Y','ENABLE GENDER FILTERING',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MIN_ADMISSION','FILTER_ENABLING',1,'Y','ENABLE MIN ADMISSION DATE FILTERING',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MAX_ADMISSION','FILTER_ENABLING',1,'Y','ENABLE MAX ADMISSION DATE FILTERING',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','DIAGNOSIS_DATE_ON_STUDY_INTERVAL','FILTER_ENABLING',1,'Y','ENABLE DIAGNOSIS DATE FILTERING',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MIN_AGE','FILTER_ENABLING',1,'Y','MINIMUM AGE AT STUDY BEGIN',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MAX_AGE','FILTER_ENABLING',1,'Y','MAXIMUM AGE AT STUDY END',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','LABORATORY','FILTER_ENABLING',1,'Y','SELECTED LAB EXAMS',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','LAB_TEST_DATE_ON_STUDY_INTERVAL','FILTER_ENABLING',1,'Y','ENABLE LAB EXAMS DATE FILTERING',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','SURGERY_DIAG_SELECTION','FILTER_ENABLING',1,'Y','ENABLE SURGERY SELECTION BY DIAGNOSIS FILTERING',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','OUTCOME_SELECTION','FILTER_ENABLING',1,'Y','ENABLE SURGERY SELECTION BY DIAGNOSIS FILTERING',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_YES_Y_NO_N_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','ENCOUNTER_SELECTION','FILTER_ENABLING',1,'Y','ENABLE OUTCOME SELECTION BY DIAGNOSIS FILTERING',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_WOMEN','MODEL_ONE','TEREZA','SURGERY_SELECTION','SURGERY_PROCEDURE',1,'%REVASC%','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','SURGERY_SELECTION','SURGERY_PROCEDURE',1,'%REVASC%','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','DIAGNOSIS_SELECTION','ICD10_CATEGORY_FULL',1,'I50','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','OUTCOME_SELECTION','ICD10_CATEGORY_FULL',1,'I21','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','OUTCOME_SELECTION','ICD10_CATEGORY_FULL',2,'I22','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','OUTCOME_SELECTION','ICD10_CATEGORY_FULL',4,'I64','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_WOMEN','MODEL_ONE','TEREZA','LABORATORY','LAB_TEST_ID',1,'HDL COL','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_WOMEN','MODEL_ONE','TEREZA','LABORATORY','LAB_TEST_ID',2,'GLICOSE','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_WOMEN','MODEL_ONE','TEREZA','LABORATORY','LAB_TEST_ID',3,'HB GLICADA','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_WOMEN','MODEL_ONE','TEREZA','LABORATORY','LAB_TEST_ID',4,'LDL COL','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_WOMEN','MODEL_ONE','TEREZA','LABORATORY','LAB_TEST_ID',5,'COLESTEROL','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

-- DCV_GENETICA
INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','LABORATORY','LAB_TEST_ID',1,'HDL COL','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','LABORATORY','LAB_TEST_ID',2,'GLICOSE','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','LABORATORY','LAB_TEST_ID',3,'HB GLICADA','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','LABORATORY','LAB_TEST_ID',4,'LDL COL','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','LABORATORY','LAB_TEST_ID',5,'COLESTEROL','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','LABORATORY','LAB_TEST_ID',6,'TROPONINA','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','STUDY_GENDER','GENDER',1,'M','I','MALE',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','STUDY_GENDER','GENDER',2,'F','I','FEMALE',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_STRING_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,INCLUSION_EXCLUSION,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','ENCOUNTER_SELECTION','ENCOUNTER_TYPE',1,'AM','I','',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_DISEASE','MODEL_ONE','TEREZA','STUDY_END','INTERVAL_DATE',1,TO_DATE('01-01-2014','DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_DISEASE','MODEL_ONE','TEREZA','MAX_ADMISSION','ADMISSION_INTERVAL',1,TO_DATE('01-01-2014','DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_WOMEN','MODEL_ONE','TEREZA','STUDY_END','INTERVAL_DATE',1,TO_DATE('01-01-2015', 'DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_WOMEN','MODEL_ONE','TEREZA','MAX_ADMISSION','ADMISSION_INTERVAL',1,TO_DATE('01-01-2015', 'DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_WOMEN','MODEL_ONE','TEREZA','MIN_DIAGNOSIS','FIRST_DIAGNOSIS_INTERVAL',1,TO_DATE('01-01-1985','DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_WOMEN','MODEL_ONE','TEREZA','MAX_DIAGNOSIS','FIRST_DIAGNOSIS_INTERVAL',1,TO_DATE('01-01-2015','DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','STUDY_BEGIN','INTERVAL_DATE',1,TO_DATE('01-01-2000','DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','STUDY_END','INTERVAL_DATE',1,TO_DATE('01-10-2016', 'DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MIN_BIRTH_DATE','BIRTH_DATE',1,TO_DATE('31-12-1899','DD-MM-YYYY'),'BORN AFTER 01/01/1900',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

-- TABLE 01 - ES_PATIENT
INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MIN_ADMISSION','ADMISSION_INTERVAL',1,TO_DATE('01-01-1985','DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
-- 25-MAR-2014 07:56:23
INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MAX_ADMISSION','ADMISSION_INTERVAL',1,TO_DATE('01-10-2016', 'DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

-- TABLE 01 - STUDY_PATIENT
INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MIN_DIAGNOSIS','FIRST_DIAGNOSIS_INTERVAL',1,TO_DATE('01-01-1982','DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MAX_DIAGNOSIS','FIRST_DIAGNOSIS_INTERVAL',1,TO_DATE('01-10-2016','DD-MM-YYYY'),'',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

-- VIEW 03 - CHOLESTEROL_RESULTS_INTERVAL
INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MAX_LAB_RESULT','LAB_RESULT_INTERVAL',1,TO_DATE('01-10-2016','DD-MM-YYYY'),'RESULTS FROM DATES UP TO THIS ONE',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

--- VIEW 17 - STUDY_PHRMCY_PRESCRIPTION_ALL
INSERT INTO 
  STUDY_PARAMS_DATE_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MIN_PRESCRIPTION','PRESCRIPTION_INTERVAL',1,TO_DATE('01-01-1982','DD-MM-YYYY'),'PRESCRIPTION FOR ADULTS (> 18)',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_NUMBER_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','ENCOUNTER_SELECTION','ENCOUNTERS_QUANTITY',1,1,'ONLY ADULTS',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_NUMBER_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MIN_AGE','STUDY_AGE',1,18,'ONLY ADULTS',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));

INSERT INTO 
  STUDY_PARAMS_NUMBER_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','MAX_AGE','STUDY_AGE',1,110,'UP TO 56',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_NUMBER_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','DAYS_AFTER_INDEX_EVENT','PCI_OUTCOME',1,30,'OUTCOME BY PCI, AT LEAST 1 MONTH AFTER FIRST DIAGNOSIS',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_NUMBER_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','DAYS_AFTER_INDEX_EVENT','SURGERY_OUTCOME',1,30,'OUTCOME BY CABG, AT LEAST 1 MONTH AFTER FIRST DIAGNOSIS',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO 
  STUDY_PARAMS_NUMBER_TYPE (RESEARCH_ID,STUDY_ID,RESEARCHER_ID,CRITERIA_ID,PARAMETER_TYPE,PARAMETER_ID,PARAMETER_VALUE,COMMENTS,INCLUSION_DATE,MODIFICATION_DATE) 
  VALUES 
    ('DCV_GENETICA','MODEL_ONE','TEREZA','DAYS_AFTER_INDEX_EVENT','DIAGNOSIS_OUTCOME',1,60,'OUTCOME BY SECOND DIAGNOSIS, AT LEAST 2 MONTH AFTER FIRST DIAGNOSIS',(SELECT TRUNC(SYSDATE) FROM DUAL),(SELECT TRUNC(SYSDATE) FROM DUAL));
...
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11290311',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11290321',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','1141263X',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11290802',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11292169',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11296365',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11297001',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11415051',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11297016',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87118550',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87114070',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87114045',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87117747',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87117752',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87117757',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87115580',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87115384',1,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11290208',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('2','ANTIAGREGANTES','11170207',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('2','ANTIAGREGANTES','1103092X',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11412501',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11292908',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11292929',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11293676',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11293688',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11295700',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010216',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010356',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010342',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','1101085X',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010836',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','1101099X',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11011191',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11052872',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11052880',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11051105',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11011778',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11011790',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11052363',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11012808',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11053976',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014131',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014155',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014404',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014179',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','1101457X',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','1101460X',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014660',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014209',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11016474',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11016486',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11016504',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11018161',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010873',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010861',0,'DCV_WOMEN','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11011439',0,'DCV_WOMEN','TEREZA');

INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11290311',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11290321',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','1141263X',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11290802',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11292169',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11296365',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11297001',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11415051',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11297016',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87118550',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87114070',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87114045',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87117747',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87117752',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87117757',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87115580',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','87115384',1,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('1','HIPOLIPIMIANTES','11290208',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('2','ANTIAGREGANTES','11170207',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('2','ANTIAGREGANTES','1103092X',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11412501',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11292908',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11292929',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11293676',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11293688',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('3','HIPOGLICEMIANTES','11295700',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010216',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010356',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010342',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','1101085X',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010836',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','1101099X',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11011191',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11052872',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11052880',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11051105',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11011778',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11011790',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11052363',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11012808',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11053976',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014131',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014155',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014404',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014179',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','1101457X',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','1101460X',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014660',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11014209',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11016474',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11016486',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11016504',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11018161',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010873',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11010861',0,'DCV_GENETICA','TEREZA');
INSERT INTO STUDY_DRUG (GROUP_ID,GROUP_NAME,DRUG_ID,INTERVENTION_DRUG,RESEARCH_ID,RESEARCHER_ID) VALUES ('4','HIPOTENSORES','11011439',0,'DCV_GENETICA','TEREZA');
...
SELECT 
        ...
        , CASE 
              WHEN RESULT_IS_NUMBER = 1 AND RESULT_OUT_OF_RANGE = 0 
                THEN TO_NUMBER(TRIM(REPLACE(LABTST_RESULT_VALUE,',','.')),'9999999999999999999999999999999999D999999', 'NLS_NUMERIC_CHARACTERS = ''. ''')
...
-- ******************************************************
CREATE OR REPLACE VIEW DETECT_INVALID_INDEX AS
(
SELECT 
    CI.DEIDENTIFIED_ID
  , CI.INTERVENTION_FLAG
  , CI.INTERVENTION_INTERVAL
  , CIO.AGE_AT_INDEX_EVENT
  , CIO.AGE_AT_OUTCOME
  , CP.AGEYEARS_AT_STUDY_BEGIN * 365 AS AGE_AT_STUDY_BEGIN
  , CP.ESTIM_AGE_AT_STUDY_END * 365 AS ESTIM_AGE_AT_STUDY_END
  , CD.AGE_AT_DEATH
  , CIV.AGE_FIRST_ENCOUNTER
  , CIV.AGE_LAST_ENCOUNTER
  
FROM 
  COHORT_INTERVENTION CI
  
INNER JOIN 
  COHORT_INDEXEVENT_OUTCOMEEVENT CIO
ON 
  CI.DEIDENTIFIED_ID = CIO.DEIDENTIFIED_ID
  
INNER JOIN
  COHORT_PATIENT CP
ON
  CP.DEIDENTIFIED_ID=CIO.DEIDENTIFIED_ID
  
INNER JOIN
  COHORT_DEATH CD
ON
  CD.DEIDENTIFIED_ID = CIO.DEIDENTIFIED_ID
  
INNER JOIN
  COHORT_ENCOUNTER CIV
ON
  CIV.DEIDENTIFIED_ID = CIO.DEIDENTIFIED_ID
WHERE
  AGE_AT_INDEX_EVENT > AGE_LAST_ENCOUNTER
);
