...
-- ******************************************************
CREATE OR REPLACE VIEW CBMS_LINKAGE_RESULTS AS
(
SELECT 2003 AS ID
, (select count(*) from STUDY_DECEASE_NO_SIM WHERE (DECEASE_DATE <= '31/12/10' and DECEASE_DATE >= '01/01/03')) as OBITOS_DCV
, (select count(*) from STUDY_DECEASE_SIM WHERE (DECEASE_DATE <= '31/12/10' and DECEASE_DATE >= '01/01/03')) as OBITOS_DCV_MAIS_SIM
, (select count(*) from STUDY_LINKAGE_SIM WHERE (DECEASE_DATE <= '31/12/10' and DECEASE_DATE >= '01/01/03')) as OBITOS_DCV_LINKAGE
, (select count (*) from STUDY_DECEASE_NO_SIM a INNER JOIN STUDY_LINKAGE_SIM b ON a.PATIENT_ID = b.PATIENT_ID AND (a.DECEASE_DATE <= '31/12/10' and a.DECEASE_DATE >= '01/01/03')) AS OBITOS_DCV_AND_LINKAGE
, (select count (*) from STUDY_LINKAGE_SIM a WHERE a.PATIENT_ID NOT IN (select b.PATIENT_ID from STUDY_DECEASE_NO_SIM b INNER JOIN STUDY_LINKAGE_SIM c ON b.PATIENT_ID = c.PATIENT_ID ) AND (a.DECEASE_DATE <= '31/12/10' and a.DECEASE_DATE >= '01/01/03')) AS OBITOS_DCV_LINKAGE_ONLY
, (select count (*) from STUDY_DECEASE_NO_SIM a WHERE a.PATIENT_ID NOT IN (select b.PATIENT_ID from STUDY_DECEASE_NO_SIM b INNER JOIN STUDY_LINKAGE_SIM c ON b.PATIENT_ID = c.PATIENT_ID ) AND (a.DECEASE_DATE <= '31/12/10' and a.DECEASE_DATE >= '01/01/03')) AS OBITOS_DCV_ONLY
from dual
UNION
SELECT 2001 AS ID
, (select count(*) from STUDY_DECEASE_NO_SIM WHERE (DECEASE_DATE <= '31/12/10' and DECEASE_DATE >= '01/01/01')) as OBITOS_DCV
, (select count(*) from STUDY_DECEASE_SIM WHERE (DECEASE_DATE <= '31/12/10' and DECEASE_DATE >= '01/01/01')) as OBITOS_DCV_MAIS_SIM
, (select count(*) from STUDY_LINKAGE_SIM WHERE (DECEASE_DATE <= '31/12/10' and DECEASE_DATE >= '01/01/01')) as OBITOS_DCV_LINKAGE
, (select count (*) from STUDY_DECEASE_NO_SIM a INNER JOIN STUDY_LINKAGE_SIM b ON a.PATIENT_ID = b.PATIENT_ID AND (a.DECEASE_DATE <= '31/12/10' and a.DECEASE_DATE >= '01/01/01')) AS OBITOS_DCV_AND_LINKAGE
, (select count (*) from STUDY_LINKAGE_SIM a WHERE a.PATIENT_ID NOT IN (select b.PATIENT_ID from STUDY_DECEASE_NO_SIM b INNER JOIN STUDY_LINKAGE_SIM c ON b.PATIENT_ID = c.PATIENT_ID ) AND (a.DECEASE_DATE <= '31/12/10' and a.DECEASE_DATE >= '01/01/01')) AS OBITOS_DCV_LINKAGE_ONLY
, (select count (*) from STUDY_DECEASE_NO_SIM a WHERE a.PATIENT_ID NOT IN (select b.PATIENT_ID from STUDY_DECEASE_NO_SIM b INNER JOIN STUDY_LINKAGE_SIM c ON b.PATIENT_ID = c.PATIENT_ID ) AND (a.DECEASE_DATE <= '31/12/10' and a.DECEASE_DATE >= '01/01/01')) AS OBITOS_DCV_ONLY
from dual

);
-- ******************************************************
CREATE OR REPLACE VIEW LINKAGE_MOTHER_RESULTS_BY_YEAR AS
(
  SELECT 1986 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1986','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1986','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1986','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1986','DD/MM/YYYY'))
    ) AS OBITOS_DCV_MAIS_SIM ,
    (SELECT COUNT(*)
    FROM STUDY_LINKAGE_MOTHER_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1986','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1986','DD/MM/YYYY'))
    ) AS OBITOS_DCV_LINKAGE ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM a
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1986','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1986','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
      (SELECT b.PATIENT_ID
      FROM STUDY_DECEASE_NO_SIM b
      INNER JOIN STUDY_LINKAGE_MOTHER_SIM c
      ON b.PATIENT_ID = c.PATIENT_ID
      )
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1986','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1986','DD/MM/YYYY'))
    ) AS OBITOS_DCV_LINKAGE_ONLY ,
    (SELECT COUNT (*)
    FROM STUDY_DECEASE_NO_SIM a
    WHERE a.PATIENT_ID NOT IN
      (SELECT b.PATIENT_ID
  ...
  SELECT 1987 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1987','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1987','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1987','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1987','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1987','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1988 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1988','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1988','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1988','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1988','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1988','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1989 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1989','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1989','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1989','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1989','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1989','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1990 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1990','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1990','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1990','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1990','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1990','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1991 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1991','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1991','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1991','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1991','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1991','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1992 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1992','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1992','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1992','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1992','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1992','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1993 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1993','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1993','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1993','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1993','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1993','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1994 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1994','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1994','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1994','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1994','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1994','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1995 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1995','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1995','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1995','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1995','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1995','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1996 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1996','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1996','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1996','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1996','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1996','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1997 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1997','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1997','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1997','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1997','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1997','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1998 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1998','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1998','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1998','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1998','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1998','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 1999 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1999','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/1999','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/1999','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/1999','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/1999','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2000 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2000','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2000','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2000','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2000','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2000','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2001 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2001','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2001','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2001','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2001','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2001','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2002 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2002','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2002','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2002','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2002','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2002','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2003 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2003','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2003','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2003','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2003','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2003','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2004 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2004','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2004','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2004','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2004','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2004','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2005 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2005','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2005','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2005','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2005','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2005','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2006 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2006','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2006','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2006','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2006','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2006','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2007 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2007','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2007','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2007','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2007','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2007','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2008 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2008','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2008','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2008','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2008','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2008','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2009 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2009','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2009','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2009','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2009','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2009','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2010 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2010','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2010','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2010','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2010','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2010','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2011 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2011','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2011','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2011','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2011','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2011','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2012 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2012','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2012','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2012','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2012','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2012','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
  ...
  SELECT 2013 AS ID ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_NO_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2013','DD/MM/YYYY')
    AND DECEASE_DATE    >= TO_DATE('01/01/2013','DD/MM/YYYY'))
    ) AS OBITOS_DCV ,
    (SELECT COUNT(*)
    FROM STUDY_DECEASE_SIM
    WHERE (DECEASE_DATE <= TO_DATE('31/12/2013','DD/MM/YYYY')
    ...
    INNER JOIN STUDY_LINKAGE_MOTHER_SIM b
    ON a.PATIENT_ID      = b.PATIENT_ID
    AND (a.DECEASE_DATE <= TO_DATE('31/12/2013','DD/MM/YYYY')
    AND a.DECEASE_DATE  >= TO_DATE('01/01/2013','DD/MM/YYYY'))
    ) AS OBITOS_DCV_AND_LINKAGE ,
    (SELECT COUNT (*)
    FROM STUDY_LINKAGE_MOTHER_SIM a
    WHERE a.PATIENT_ID NOT IN
...
-- ******************************************************
CREATE OR REPLACE VIEW LINKAGE_RESULTS_BY_YEAR AS
(
