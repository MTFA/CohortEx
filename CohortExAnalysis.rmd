...
tableCount <- incCount(tableCount, "PauÃ¡ Totals")
````

`r I(pasteLabel("Table", tableCount, "PauÃ¡ Totals", FALSE))` Overall database totals.
...
tableCount <- incCount(tableCount, "Pauá Diagnosis Profile")

```

`r I(pasteLabel("Tabela", tableCount, "Pauá Diagnosis Profile", FALSE))` Pauá diagnosis profile.

```{r message=FALSE, results='asis',echo=FALSE}
perfilDiag <- INDICATOR_DIAGNOSIS_PROFILE

qualidadeBase <- tableCat(perfilDiag)

cat(qualidadeBase, sep = "\n")
