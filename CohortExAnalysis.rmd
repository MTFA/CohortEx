...
demog <- merge(COHORT_PATIENT,COHORT_INDEXEVENT_OUTCOMEEVENT,by="DEIDENTIFIED_ID")

# Recode age intervals
demog$FAIXA_ETARIA <- recode(floor(demog$AGE_AT_INDEX_EVENT/365), 
                             '18:30 = "18 a 29"; 30:40 = "30 a 39"; 40:50 = "40 a 49"; 50:60 = "50 a 59"; 60:70 = "60 a 69"; 70:80 = "70 a 79"; 80:110 = "80 e mais" ; ; ; ;',
                             as.factor.result=TRUE)

xy.pop <- data.frame (table (demog$FAIXA_ETARIA[demog$GENDER=="M" & floor(demog$AGE_AT_INDEX_EVENT/365) > 17]))
xx.pop <- data.frame (table (demog$FAIXA_ETARIA[demog$GENDER=="F" & floor(demog$AGE_AT_INDEX_EVENT/365) > 17]))
